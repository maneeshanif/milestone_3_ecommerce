...
const FooterTop = () => {
  const incentives = [
    ...
    },
    {
      name: "Exchanges",
      imageSrc:
        <MdOutlineCurrencyExchange className="w-24 h-16" />,
      description:
        "If you don't like it, trade it to one of your friends for something of theirs. Don't send it here though.",
    },
  ];
  return (
    <div className="max-w-screen-xl mx-auto px-4 md:px-0 py-10">
